										...
										<div class="col-12">
											<div class="form-group">
												...
												<input
													...
													class="form-control"
													name="meta_title"
													placeholder="Add Meta Title For Google Search"
													id="meta_title"
													data-ub-tag-variant="dark"
										...
										<div class="col-12">
											<div class="form-group">
												...
												<textarea
													...
													placeholder="Add Meta Description For Google Search"
													id="meta_description"
													data-ub-tag-variant="dark">{{ old('meta_description') }}</textarea>
										...
										<div class="col-12">
											<div class="form-group">
												...
												<textarea
													class="form-control"
													name="custom_header"
													placeholder="If you want to add custom header for this article"
													id="custom_header"
													data-ub-tag-variant="dark">{{ old('custom_header') }}</textarea>

												@if ($errors->has('custom_header'))
												<span class="help-block text-danger">
													<p>{{ $errors->first('custom_header') }}</p>
												</span>
												@endif
											</div>
										</div>
										...
										<div class="col-12">
											<div class="form-group">
												...
												<input
													...
													class="form-control"
													name="meta_keywords"
													placeholder="Add Meta Keywords For Google Search"
													id="meta_keywords"
													data-ub-tag-variant="dark"
...
<script>
	ClassicEditor
		.create(document.querySelector('#content'), {
			ckfinder: {
				uploadUrl: '/upload-image?_token={{ csrf_token() }}' // Adjust the upload URL as needed
			},
			toolbar: [
				'heading', // This includes the 'Heading' dropdown
				'alignment', // Add alignment options here
				'|',
				'imageUpload', // This adds the image upload button
				'|',
				'bold',
				'italic',
				'link',
				...
				'|',
				'blockQuote',
				'insertTable', // This will add the table option
				'|',
				'undo', // Optional: Add undo/redo options
				'redo'
			],
			heading: {
				options: [{
			...
			alignment: {
				options: ['left', 'center', 'right', 'justify'] // Add alignment options here
			}
		})
